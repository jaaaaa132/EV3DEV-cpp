...
public:
  ...
  void run_to_abs_pos(int position, int speed, const char* stop_action = "brake");
  void run_to_rel_pos(int position, int speed, const char* stop_action = "brake");
  void run_for_time(int time_ms, int speed, const char* stop_action = "brake");
  void stop(const char* stop_action = "brake");
  void run_direct(int duty_cycle, bool inverted = false);
  void run_direct_for_time(int duty_cycle, int time_ms, bool inverted = false, const char* stop_action = "brake");
